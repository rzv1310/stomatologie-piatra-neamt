...
import urgenteHero from "@/assets/service-urgente.jpg?w=1200&format=webp";
import toothBrokenIcon from "@/assets/icon-tooth-broken.png?w=64&format=webp";
import toothInfectionIcon from "@/assets/icon-tooth-infection.png?w=64&format=webp";
import toothPainIcon from "@/assets/icon-tooth-pain.png?w=64&format=webp";
import toothDamagedIcon from "@/assets/icon-tooth-damaged.png?w=64&format=webp";
import bleedingIcon from "@/assets/icon-bleeding.png?w=64&format=webp";
import surgeryIcon from "@/assets/icon-surgery.png?w=64&format=webp";
import rapidResponseIcon from "@/assets/icon-rapid-response.png?w=64&format=webp";
import equipmentIcon from "@/assets/icon-equipment.png?w=64&format=webp";
import painManagementIcon from "@/assets/icon-pain-management.png?w=64&format=webp";
