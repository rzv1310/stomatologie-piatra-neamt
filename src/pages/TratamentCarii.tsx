...
import heroImage from "@/assets/service-tratament-carii.jpg?w=1200&format=webp";
  ...
  const steps = [
    {
      ...
      description: <>Examinare dentară completă și identificarea cariilor prin inspecție vizuală și radiografii dentare, precedată de <Link to="/servicii/profilaxie" className="text-primary hover:underline font-medium">profilaxie profesională</Link></>
    },
    {
      number: "02",
