...
const Chirurgie = () => {
  ...
  const pricingData = [{
    service: "Extracție dinte parodontotic",
    price: "100 lei"
  }, {
    service: "Extracție monoradicular",
    price: "150 lei"
  }, {
    service: "Extracție pluriradicular",
    price: "200-250 lei"
  }, {
    service: "Extracție molar de minte",
    price: "300-400 lei"
  }, {
    service: "Extracție rest radicular",
    price: "200 lei"
  }, {
    service: "Adiție osoasă mică (1-2 elemente)",
    price: "2000-2500 lei"
  }, {
    service: "Adiție osoasă mare (3-6 elemente)",
    price: "3000-3500 lei"
  }, {
    service: "Sinus Lift Extern",
    price: "de la 4000 lei"
  }, {
    service: "Sinus Lift Intern",
    price: "de la 2000 lei"
  }];
  ...
  const wisdomTeethInfo = [{
    ...
    points: ["Durere cronică sau recurentă în zona molarilor", "Infecții repetate (pericoronarite)", "Dinte inclus care afectează dinții vecini", "Chisturi sau tumori asociate molarului", "Carii pe molarii de minte greu accesibili", "Înainte de tratament ortodontic"]
  }];
  const faqs = [{
  ...
  return <div className="min-h-screen flex flex-col">
      ...
      <section className="relative h-[60vh] min-h-[500px] flex items-center">
        <div className="absolute inset-0 bg-cover bg-center" style={{
          backgroundImage: `url(${chirurgieHero})`
        }} />
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl text-white">
            ...
            <HeroContactBox microcopy="✓ Consultație gratuită · Răspuns rapid · Sedare disponibilă" />
          </div>
        </div>
      </section>
            ...
            <Card className="border-primary/20">
              <CardContent className="p-0">
                <Table>
                  ...
                  <TableBody>
                    {pricingData.map((item, index) => <TableRow key={index}>
      ...
      <section className="py-20 bg-hero">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {surgicalServices.map((service, index) => <Card key={index} className="border-primary/20">
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
            {benefits.map((benefit, index) => <Card key={index} className="border-primary/20">
                <CardContent className="p-6">
      ...
      <section className="py-20 bg-hero">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto space-y-6">
            {extractionSteps.map((step, index) => <Card key={index} className="border-primary/20 hover:shadow-md transition-shadow">
                <CardContent className="p-6">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-8 text-center">
              <p className="text-lg text-text-custom">
                Molarii de minte (al treilea molar) sunt ultimii dinți care erup, de obicei între 17-25 de ani. În multe cazuri, aceștia cauzează probleme și necesită extracție. Citește mai multe despre <Link to="/blog/maseaua-de-minte" className="text-primary hover:underline font-medium">măseaua de minte</Link>.
              </p>
            </div>
            {wisdomTeethInfo.map((info, index) => <Card key={index} className="border-primary/20 mb-6">
                <CardContent className="p-6">
                  <h3 className="text-2xl font-semibold mb-4 text-heading">{info.title}</h3>
                  <ul className="space-y-3">
                    {info.points.map((point, idx) => <li key={idx} className="flex items-start">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <Accordion type="single" collapsible className="space-y-4">
              {faqs.map((faq, index) => <AccordionItem key={index} value={`item-${index}`} className="border border-primary/20 rounded-lg px-6">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <CTAWithTrust primaryButton={{
              ...
              icon: "💉",
              text: "Anestezie locală modernă"
            }, {
              icon: "🔬",
              text: "CBCT pentru precizie maximă"
            }, {
              icon: "⚡",
              text: "Recuperare rapidă"
            }]} />
          </div>
        </div>
      </section>
