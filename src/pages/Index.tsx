      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-text-custom">
              Clinica este situată ultracentral, pe Strada Ana Ipătescu 9, <a href="https://ro.wikipedia.org/wiki/Piatra-Neam%C8%9B" target="_blank" rel="nofollow noopener noreferrer" className="text-accent hover:underline">Piatra Neamț 610120</a>, în spate la Magazinul UNIC,  Școala Gimnazială nr. 12 „Spiru Haret" și clinica Medlife Micromedica.
